...
public:
    ...
    {
        QgsAuthSslConfigWidget->setWindowTitle(QApplication::translate("QgsAuthSslConfigWidget", "Form", nullptr));
        grpbxCert->setTitle(QApplication::translate("QgsAuthSslConfigWidget", "Certificate", nullptr));
        lblCert->setText(QApplication::translate("QgsAuthSslConfigWidget", "Name", nullptr));
        leHost->setPlaceholderText(QApplication::translate("QgsAuthSslConfigWidget", "host:port (required)", nullptr));
        leCommonName->setPlaceholderText(QString());
#ifndef QT_NO_TOOLTIP
        btnCertInfo->setToolTip(QApplication::translate("QgsAuthSslConfigWidget", "Show information for certificate", nullptr));
#endif // QT_NO_TOOLTIP
        btnCertInfo->setText(QApplication::translate("QgsAuthSslConfigWidget", "?", nullptr));
        lblServer->setText(QApplication::translate("QgsAuthSslConfigWidget", "Server", nullptr));
        grpbxSslConfig->setTitle(QApplication::translate("QgsAuthSslConfigWidget", "Custom SSL configuration", nullptr));
        QTreeWidgetItem *___qtreewidgetitem = treeSslConfig->headerItem();
        ___qtreewidgetitem->setText(0, QApplication::translate("QgsAuthSslConfigWidget", "Field", nullptr));
    } // retranslateUi
