...
public:
    ...
    {
        QgsAuthSslTestDialog->setWindowTitle(QApplication::translate("QgsAuthSslTestDialog", "Custom Certificate Configuration", nullptr));
        lblWarningIcon->setText(QString());
        lblWarningText->setText(QApplication::translate("QgsAuthSslTestDialog", "<html><head/><body><p>Save a custom SSL server configuration, importing certificate from server or file. WARNING: Only save configurations when necessary.</p></body></html>", nullptr));
        grpbxServer->setTitle(QApplication::translate("QgsAuthSslTestDialog", "Import Certificate", nullptr));
        radioServerImport->setText(QApplication::translate("QgsAuthSslTestDialog", "From server", nullptr));
        lblHttps->setText(QApplication::translate("QgsAuthSslTestDialog", "https://", nullptr));
        leServer->setPlaceholderText(QApplication::translate("QgsAuthSslTestDialog", "www.example.com", nullptr));
        label->setText(QApplication::translate("QgsAuthSslTestDialog", ":", nullptr));
        btnConnect->setText(QApplication::translate("QgsAuthSslTestDialog", "Connect", nullptr));
        lblTimeout->setText(QApplication::translate("QgsAuthSslTestDialog", "Timeout", nullptr));
        spinbxTimeout->setSuffix(QApplication::translate("QgsAuthSslTestDialog", " sec", nullptr));
        radioFileImport->setText(QApplication::translate("QgsAuthSslTestDialog", "From file", nullptr));
        leCertPath->setPlaceholderText(QApplication::translate("QgsAuthSslTestDialog", "PEM/DER formatted file", nullptr));
        btnCertPath->setText(QApplication::translate("QgsAuthSslTestDialog", "\342\200\246", nullptr));
    } // retranslateUi
