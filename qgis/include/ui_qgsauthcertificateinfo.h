...
public:
    ...
    {
        QgsAuthCertInfo->setWindowTitle(QApplication::translate("QgsAuthCertInfo", "Certificate Info", nullptr));
        grpbxHierarchy->setTitle(QApplication::translate("QgsAuthCertInfo", "Certificate Hierarchy", nullptr));
        lblError->setText(QApplication::translate("QgsAuthCertInfo", "TextLabel", nullptr));
        groupBox->setTitle(QApplication::translate("QgsAuthCertInfo", "Certificate Information", nullptr));
        grpbxTrust->setTitle(QString());
        label->setText(QApplication::translate("QgsAuthCertInfo", "Trust policy", nullptr));
#ifndef QT_NO_TOOLTIP
        btnSaveTrust->setToolTip(QApplication::translate("QgsAuthCertInfo", "Save certificate trust policy change to database", nullptr));
#endif // QT_NO_TOOLTIP
        btnSaveTrust->setText(QApplication::translate("QgsAuthCertInfo", "Save", nullptr));
    } // retranslateUi
