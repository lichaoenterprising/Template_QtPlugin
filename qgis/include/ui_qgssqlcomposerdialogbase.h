...
public:
    ...
    {
        QgsSQLComposerDialogBase->setWindowTitle(QApplication::translate("QgsSQLComposerDialogBase", "SQL Query Composer", nullptr));
        mSQLStatementLabel->setText(QApplication::translate("QgsSQLComposerDialogBase", "SQL Statement", nullptr));
#ifndef QT_NO_TOOLTIP
        mQueryEdit->setToolTip(QApplication::translate("QgsSQLComposerDialogBase", "<html><head/><body><p>This is the SQL query editor.</p></body></html>", nullptr));
#endif // QT_NO_TOOLTIP
        mColumnsLabel->setText(QApplication::translate("QgsSQLComposerDialogBase", "Columns", nullptr));
        mTablesLabel->setText(QApplication::translate("QgsSQLComposerDialogBase", "Table(s)", nullptr));
        mTablesEditor->setText(QString());
        mJoinsLabels->setText(QApplication::translate("QgsSQLComposerDialogBase", "Joins", nullptr));
        QTableWidgetItem *___qtablewidgetitem = mTableJoins->horizontalHeaderItem(0);
        ___qtablewidgetitem->setText(QApplication::translate("QgsSQLComposerDialogBase", "Joint layer", nullptr));
        QTableWidgetItem *___qtablewidgetitem1 = mTableJoins->horizontalHeaderItem(1);
        ___qtablewidgetitem1->setText(QApplication::translate("QgsSQLComposerDialogBase", "ON condition", nullptr));
        mAddJoinButton->setText(QString());
        mRemoveJoinButton->setText(QString());
        mWhereLabel->setText(QApplication::translate("QgsSQLComposerDialogBase", "Where    ", nullptr));
        mOrderLabel->setText(QApplication::translate("QgsSQLComposerDialogBase", "Order by", nullptr));
        mTablesCombo->setItemText(0, QApplication::translate("QgsSQLComposerDialogBase", "Tables", nullptr));

        mColumnsCombo->setItemText(0, QApplication::translate("QgsSQLComposerDialogBase", "Columns", nullptr));

        mAggregatesCombo->setItemText(0, QApplication::translate("QgsSQLComposerDialogBase", "Aggregates", nullptr));

        mFunctionsCombo->setItemText(0, QApplication::translate("QgsSQLComposerDialogBase", "Functions", nullptr));

        mSpatialPredicatesCombo->setItemText(0, QApplication::translate("QgsSQLComposerDialogBase", "Spatial predicates", nullptr));

        mStringFunctionsCombo->setItemText(0, QApplication::translate("QgsSQLComposerDialogBase", "Strings functions", nullptr));

        mOperatorsCombo->setItemText(0, QApplication::translate("QgsSQLComposerDialogBase", "Operators", nullptr));

        mToolbox->setItemText(mToolbox->indexOf(mPageData), QApplication::translate("QgsSQLComposerDialogBase", "Data", nullptr));
        columns_2->setItemText(0, QApplication::translate("QgsSQLComposerDialogBase", "Columns", nullptr));

        extract->setText(QApplication::translate("QgsSQLComposerDialogBase", "Only 10 first values", nullptr));
        mToolbox->setItemText(mToolbox->indexOf(mPageColumnsValues), QApplication::translate("QgsSQLComposerDialogBase", "Columns' values", nullptr));
    } // retranslateUi
