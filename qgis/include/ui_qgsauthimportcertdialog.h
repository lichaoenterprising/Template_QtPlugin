...
public:
    ...
    {
        QgsAuthImportCertDialog->setWindowTitle(QApplication::translate("QgsAuthImportCertDialog", "Import Certificate(s)", nullptr));
        grpbxImportCert->setTitle(QApplication::translate("QgsAuthImportCertDialog", "Import Certificate(s)", nullptr));
        leImportFile->setPlaceholderText(QApplication::translate("QgsAuthImportCertDialog", "PEM/DER-formatted ", nullptr));
        btnImportFile->setText(QApplication::translate("QgsAuthImportCertDialog", "\342\200\246", nullptr));
        lblMultiCerts->setText(QApplication::translate("QgsAuthImportCertDialog", "Import(s) can contain multiple certificates", nullptr));
        radioImportText->setText(QApplication::translate("QgsAuthImportCertDialog", "PEM text", nullptr));
        radioImportFile->setText(QApplication::translate("QgsAuthImportCertDialog", "File", nullptr));
        lblTrust->setText(QApplication::translate("QgsAuthImportCertDialog", "Trust policy", nullptr));
        grpbxValidation->setTitle(QApplication::translate("QgsAuthImportCertDialog", "Validation Results", nullptr));
        chkAllowInvalid->setText(QApplication::translate("QgsAuthImportCertDialog", "Allow invalid certificates", nullptr));
    } // retranslateUi
