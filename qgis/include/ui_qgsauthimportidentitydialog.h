...
public:
    ...
    {
        QgsAuthImportIdentityDialog->setWindowTitle(QApplication::translate("QgsAuthImportIdentityDialog", "Import Identity", nullptr));
        grpbxImportCert->setTitle(QApplication::translate("QgsAuthImportIdentityDialog", "Import Identity", nullptr));
        lblPkiPathsKey->setText(QApplication::translate("QgsAuthImportIdentityDialog", "Key", nullptr));
        lblPkiPathsCert->setText(QApplication::translate("QgsAuthImportIdentityDialog", "Cert", nullptr));
        lePkiPathsKey->setPlaceholderText(QApplication::translate("QgsAuthImportIdentityDialog", "Required", nullptr));
        btnPkiPathsKey->setText(QApplication::translate("QgsAuthImportIdentityDialog", "\342\200\246", nullptr));
        lePkiPathsKeyPass->setPlaceholderText(QApplication::translate("QgsAuthImportIdentityDialog", "Optional passphrase", nullptr));
        chkPkiPathsPassShow->setText(QApplication::translate("QgsAuthImportIdentityDialog", "Show", nullptr));
        btnPkiPathsCert->setText(QApplication::translate("QgsAuthImportIdentityDialog", "\342\200\246", nullptr));
        lePkiPathsCert->setPlaceholderText(QApplication::translate("QgsAuthImportIdentityDialog", "Required", nullptr));
        lblPkiPathsKey_2->setText(QApplication::translate("QgsAuthImportIdentityDialog", "Key", nullptr));
        btnPkiPkcs12Bundle->setText(QApplication::translate("QgsAuthImportIdentityDialog", "\342\200\246", nullptr));
        lePkiPkcs12Bundle->setPlaceholderText(QApplication::translate("QgsAuthImportIdentityDialog", "Required", nullptr));
        lblPkiPathsCert_2->setText(QApplication::translate("QgsAuthImportIdentityDialog", "Bundle", nullptr));
        lePkiPkcs12KeyPass->setPlaceholderText(QApplication::translate("QgsAuthImportIdentityDialog", "Optional passphrase", nullptr));
        chkPkiPkcs12PassShow->setText(QApplication::translate("QgsAuthImportIdentityDialog", "Show", nullptr));
        grpbxValidation->setTitle(QApplication::translate("QgsAuthImportIdentityDialog", "Validation Results", nullptr));
    } // retranslateUi
