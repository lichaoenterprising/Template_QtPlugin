...
public:
    ...
    {
        QgsMessageViewer->setWindowTitle(QApplication::translate("QgsMessageViewer", "QGIS Message", nullptr));
        checkBox->setText(QApplication::translate("QgsMessageViewer", "Don't show this message again", nullptr));
    } // retranslateUi
