...
public:
    ...
    {
        QgsAuthConfigUriEdit->setWindowTitle(QApplication::translate("QgsAuthConfigUriEdit", "Dialog", nullptr));
        groupBox->setTitle(QApplication::translate("QgsAuthConfigUriEdit", "Edit Authentication Configuration ID", nullptr));
        label->setText(QApplication::translate("QgsAuthConfigUriEdit", "Note: Button actions above affect authentication database", nullptr));
    } // retranslateUi
