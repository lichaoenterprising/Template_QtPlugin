...
public:
    ...
    void setupUi(QWidget *QgsAuthEditors)
    {
        ...
        lblNote->setStyleSheet(QStringLiteral("QLabel {color: rgb(128, 128, 128);}"));
    ...
    {
        QgsAuthEditors->setWindowTitle(QApplication::translate("QgsAuthEditors", "Authentication Editors", nullptr));
        grpbxConfigs->setTitle(QApplication::translate("QgsAuthEditors", "Configurations", nullptr));
        grpbxManagers->setTitle(QApplication::translate("QgsAuthEditors", "Management", nullptr));
        btnAuthPlugins->setText(QApplication::translate("QgsAuthEditors", "Installed Plugins", nullptr));
        btnCertManager->setText(QApplication::translate("QgsAuthEditors", "Manage Certificates", nullptr));
        btnAuthUtilities->setText(QApplication::translate("QgsAuthEditors", "Utilities", nullptr));
        lblNote->setText(QApplication::translate("QgsAuthEditors", "Note: Editing writes directly to authentication database", nullptr));
    } // retranslateUi
