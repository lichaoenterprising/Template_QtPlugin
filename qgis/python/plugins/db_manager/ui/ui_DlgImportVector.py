...
class Ui_DbManagerDlgImportVector(object):
    def setupUi(self, DbManagerDlgImportVector):
        ...
        self.btnUpdateInputLayer = QtWidgets.QPushButton(self.wdgInput)
        self.btnUpdateInputLayer.setObjectName("btnUpdateInputLayer")
        ...
        DbManagerDlgImportVector.setTabOrder(self.chkSelectedFeatures, self.btnUpdateInputLayer)
        DbManagerDlgImportVector.setTabOrder(self.btnUpdateInputLayer, self.cboSchema)
    ...
    def retranslateUi(self, DbManagerDlgImportVector):
        ...
        self.btnUpdateInputLayer.setText(_translate("DbManagerDlgImportVector", "Update options"))
        ...
        self.chkSinglePart.setText(_translate("DbManagerDlgImportVector", "Create single-part geometries instead of multi-part"))
